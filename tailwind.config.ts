  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "emerald-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--secondary) / 0.3), 0 0 40px hsl(var(--secondary) / 0.1)" },
          "50%": { boxShadow: "0 0 30px hsl(var(--secondary) / 0.4), 0 0 60px hsl(var(--secondary) / 0.2)" }
        },
        "fog-drift": {
